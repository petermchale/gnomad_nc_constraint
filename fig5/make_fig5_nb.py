...
set: 86.6% of non-CpG background sites are in QC-pass windows (80.5% in the scored
population, 6.1% coding) and 13.3% in QC-fail ones. `preconditions/verify_qc_filter.py` records both, and confirms the
