...
| `runlog.py` | 95 | The tee behind those two logs — command, commit stamp, path scrubbing, colour stripped on the way to the file. Not `preconditions/report.py`, on purpose; the docstring says why. |
