...
| `okf/` | 870 | The experiment-planning bundle written before the analysis: hypothesis, pipeline, what the training data is, what code was missing, and a dated log. Historical record — it names files that have since been deleted. |
