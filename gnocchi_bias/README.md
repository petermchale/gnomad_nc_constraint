...
| `dnm_model.py` | The DNM training set and the per-context mutation model: loading, regime-1 subsampling, univariate feature selection, the multivariate PCA+logit fit, genome-wide `r(w)` apply, training-set prediction and reliability binning |
