...
**All 7 precondition checks pass** (30 claims).
...
| [`verify_qc_filter`](verify_qc_filter.log) | PASS | 11/11 | 2026-08-11 21:20 UTC | `476292e` | the published window filter holds in both directions -- every scored window satisfies it, every absent one fails it -- and pass_qc itself is a constant |
...
_PASS, 2s, 2026-08-11 21:20 UTC._
