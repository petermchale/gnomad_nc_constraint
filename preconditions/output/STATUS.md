...
**All 7 precondition checks pass** (28 claims).
...
| [`verify_qc_filter`](verify_qc_filter.log) | PASS | 9/9 | 2026-08-11 20:38 UTC | `72c756d` | the published window filter holds in both directions -- every scored window satisfies it, every absent one fails it -- and pass_qc itself is a constant |
...
_PASS, 2s, 2026-08-11 20:38 UTC._
